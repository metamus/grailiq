...
/** Segmented control for Home tab */
...
/**
 * Home screen combining Dashboard (Overview) and Portfolio.
...
export function HomeScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <SegmentedControl
        options={['Overview', 'Portfolio']}
        selectedIndex={selectedTab}
        onSegmentChange={setSelectedTab}
      />
      {selectedTab === 0 ? <DashboardScreen /> : <PortfolioScreen />}
    </View>
  );
}
